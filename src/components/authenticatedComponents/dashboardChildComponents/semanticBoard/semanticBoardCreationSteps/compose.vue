<template>
    <div class="tab" id="compose_tab">
        ...
        <attributeListingModal
                v-bind:closeModal="attributeListingModal.off"
            ...
            <div class="table_header_holder choose_platform_cols add">
                ...
                <ul class="variant_list list_none">
                    <li style="cursor: pointer;" v-bind:class="index == variantIndex ? 'active': ''"
                        ...
                        v-on:click="shiftVariant(index)">Variant
                        <em
            ...
            <div class="table_header_holder choose_platform_cols">
                <div class="col" v-show="rules[ruleIndex].platform.vShow">
                    <div class="holder">
                        ...
                        <select
                                v-bind:disabled="rules[ruleIndex].platform.vDisabled"
                                v-model="variantsArray[variantIndex].platform"
                        >
                            <option
                                    v-bind:value="platform"
                                    v-for="platform in inAppPushData.platformList"
                            >{{platform.name}}
                            </option>
                        </select>
                    </div>
                ...
                <div class="col" v-show="rules[ruleIndex].messageType.vShow">
                    <div class="holder">
                        ...
                        <select
                                v-bind:disabled="rules[ruleIndex].messageType.vDisabled"
                                v-model="variantsArray[variantIndex].messageType"
                                v-on:change="changeMessageType"
                        >
                            <option
                                    v-bind:value="messageType"
                                    v-for="messageType in inAppPushData.messageTypeList"
                            >{{messageType.name}}
                            </option>
                        </select>
                    </div>
                ...
                <div class="col" v-show="rules[ruleIndex].orientation.vShow">
                    <div class="holder">
                        ...
                        <select
                                v-bind:disabled="rules[ruleIndex].orientation.vDisabled"
                                v-model="variantsArray[variantIndex].orientation"
                        >
                            <option
                                    v-bind:disabled="layoutType.name == 'Landscape' ? true: false"
            ...
            >
                ...
                <div class="column_text new_col" v-show="rules[ruleIndex].pushInAppControl.vShow">
                    <div class="table_header_holder">
                        ...
                        <div class="col dummyCol" v-if="inAppPushData" v-show="rules[ruleIndex].position.vShow">
                            <div class="holder">
                                <select
                                        v-bind:disabled="rules[ruleIndex].position.vDisabled"
                                        v-model="variantsArray[variantIndex].position"
                                >
                                    <option
                                            v-bind:value="devicePosition"
                    ...
                    <div class="compose_layout_holder">
                        <div class="dialogue_holder">
                            <div class="full_height" style="display: none;">
                                <div
                                        id="bind_template"
                                        v-bind:key="variantIndex + '' + langIndex"
                            ...
                            <p style="text-align: center" class="error" v-if="validationShow">
                            ...
                            <div v-bind:class="variantsArray[variantIndex].messageType.name">
                                <div class="preview_skin" v-bind:class="changeDevice">
                                    <div class="iframe_holder">
                                        <iframe
                                                class="iframe_el"
                                                v-bind:srcdoc="iframeStyleLink + variantsArray[variantIndex].lang[langIndex].templateInfo.template"
                                        ></iframe>
                                    </div>
                                </div>
                            </div>
                        ...
                        <strong class="notice">
                            Actual rendering may not be identical to this preview depending on the
                            user’s environment.
                        </strong>
                    </div>
                </div>
                <div class="column_text" v-show="rules[ruleIndex].emailControl.vShow">
                    <div class="languages_holder" style="position: relative">
                        <strong class="anchor_pointer" v-on:click.stop="addLangPopUp()">
                        ...
                        <ul class="list_none flags">
                            ...
                            >
                                ...
                                <i
                                        ...
                                        v-on:click.stop="removeLang(language)"
                                ></i>
            ...
            >
                <strong class="title">
                    <ul class="compose_tabs list_none">
                        <li
                                v-bind:class="composeTab == 1 ? 'active': ''"
                                v-show="rules[ruleIndex].composeTab.vShow"
                        >
                            <a class="anchor_pointer" v-on:click="shiftComposeTabs(1)">
                                <i class="fas fa-pencil-alt"></i>
                            </a>
                        </li>
                        <li
                                v-bind:class="composeTab == 2 ? 'active': ''"
                                v-show="rules[ruleIndex].brushTab.vShow"
                        >
                            <a class="anchor_pointer" v-on:click="shiftComposeTabs(2)">
                                <i class="fas fa-paint-brush"></i>
                            </a>
                        </li>
                        <!-- <li
                                v-bind:class="composeTab == 3 ? 'active': ''"
                                v-show="rules[ruleIndex].settingsTab.vShow"
                        >
                            <a class="anchor_pointer" v-on:click="shiftComposeTabs(3)">
                                <i class="fas fa-cog"></i>
                            </a>
                        </li> -->
                        <li
                                v-bind:class="composeTab == 4 ? 'active': ''"
                                v-show="rules[ruleIndex].sendTestTab.vShow"
                        >
                            <a class="anchor_pointer" v-on:click="shiftComposeTabs(4)">
                ...
                <div class="compose_tab_content">
                                    ...
                                    <fieldset>
                                        <div class="label_holder" v-show="rules[ruleIndex].title.vShow">
                                            <div class="variant_drop attr_holder">
                                                <strong>
                                                    <a v-on:click="activateAttributeModal('title_field')">
                                                        <i class="fas fa-plus"></i> Add Attribute
                                                    </a>
                                                </strong>
                                                <strong
                                                        v-if="this.campaignType.code != undefined && this.campaignType.code.toLowerCase() == 'push'"
                                                >
                                                    <a v-on:click="activateEmojiModal('title_field')">
                                                        <i class="fas fa-plus"></i> Insert Emoji
                                                    </a>
                                                </strong>
                                            </div>
                                        ...
                                        />
                                        <p class="error" v-if="validationShow">{{errors.title.message}}</p>
                                        <div class="label_holder" v-show="rules[ruleIndex].message.vShow">
                                            <div class="variant_drop attr_holder">
                                                <strong>
                                                    <a v-on:click="activateAttributeModal('msg_field')">
                                                        <i class="fas fa-plus"></i> Add Attribute
                                                    </a>
                                                </strong>
                                                <strong
                                                        v-if="this.campaignType.code != undefined && this.campaignType.code.toLowerCase() == 'push'"
                                                >
                                                    <a v-on:click="activateEmojiModal('msg_field')">
                                                        <i class="fas fa-plus"></i> Insert Emoji
                                                    </a>
                                                </strong>
                                            </div>
                                        ...
                                        <textarea
                                                ...
                                                v-show="rules[ruleIndex].message.vShow"
                                        ></textarea>
                                        <p class="error" v-if="validationShow">{{errors.message.message}}</p>

                                        <div class="label_holder" v-if="rules[ruleIndex].galleryControl.vShow">
                                            <label>
                                                Image
                                                <a
                                                        v-on:click="activateGalleryModal"
                                                        class="anchor_pointer popup_opener img_upload_btn"
                                                >
                                                    Launch
                                                    image gallery
                                                </a>
                                            ...
                                            <div class="col" v-show="rules[ruleIndex].action1Label.vShow">
                                                <div class="holder">
                                                    <div class="label_holder">
                                                        <label for="button_1">Action 1</label>
                                                    </div>
                                                    <input
                                                    ...
                                                    />
                                                    <p class="error" v-if="validationShow">
                                                        {{errors.action1.label.message}}</p>
                                                </div>
                                            </div>
                                            <div class="col" v-show="rules[ruleIndex].action2Label.vShow">
                                                <div class="holder">
                                                    <div class="label_holder">
                                                        <label for="button_2">Action 2</label>
                                                    </div>
                                                    <input
                                                    ...
                                                    />
                                                    <p class="error" v-if="validationShow">
                                                        {{errors.action2.label.message}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                        ...
                        <div class="compose_widget">
                            ...
                            <div class="column_text" v-if="inAppPushData">
                                ...
                                <div class="row" v-show="rules[ruleIndex].action1Type.vShow">
                                    ...
                                    <select
                                            class="add"
                                            v-bind:disabled="rules[ruleIndex].action1Type.vDisabled"
                                            v-model="variantsArray[variantIndex].lang[langIndex].templateInfo.action1.type"
                                    >
                                        <option
                                                v-bind:value="action"
                                                v-for="action in inAppPushData.actionList"
                                    ...
                                    />
                                    <p class="error" v-if="validationShow">{{errors.action1.value.message}}</p>
                                </div>
                                <div class="row" v-show="rules[ruleIndex].action2Type.vShow">
                                    <h5>Action 2</h5>
                                    <select
                                            class="add"
                                            v-bind:disabled="rules[ruleIndex].action2Type.vDisabled"
                                    ...
                                    />
                                    <p class="error" v-if="validationShow">{{errors.action2.value.message}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="compose_widget">
                                        ...
                                        <div class="txt">
                                            <ul class="alignments list_none text-right">
                                                <li>
                                                    ...
                                                    >{{variantsArray[variantIndex].lang[langIndex].templateInfo.design.header.headingColor}}</span>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="txt">
                                            <ul class="alignments list_none text-right">
                                                <li>
                                                    ...
                                                    <span
                                                            class="selected_color_value"
                                                    >{{variantsArray[variantIndex].lang[langIndex].templateInfo.design.header.contentColor}}</span>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="colors_row no_border">
                                <div class="colors_row_holder">
                                        ...
                                        <div class="txt">
                                            <ul class="alignments list_none">
                                                <li>
                                                    ...
                                                    <span
                                                            class="selected_color_value"
                                                    >{{variantsArray[variantIndex].lang[langIndex].templateInfo.design.button1.color}}</span>
                                                    <em>Opacity</em>
                                                    <input
                                                            placeholder="100"
                                                            type="text"
                                        ...
                                        <div class="txt">
                                            <ul class="alignments list_none">
                                                <li>
                                                    ...
                                                    <span
                                                            class="selected_color_value"
                                                    >{{variantsArray[variantIndex].lang[langIndex].templateInfo.design.button1.textColor}}</span>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="txt">
                                            <ul class="alignments list_none">
                                                <li>
                                                    ...
                                                    <span
                                                            class="selected_color_value"
                                                    >{{variantsArray[variantIndex].lang[langIndex].templateInfo.design.button2.color}}</span>
                                                    <em>Opacity</em>
                                                    <input
                                                            placeholder="100"
                                                            type="text"
                                    ...
                                    <div
                                            class="colors_inner_div abc"
                                            v-show="rules[ruleIndex].backgroundSection.vShow"
                                    >
                                        <div class="txt">
                                            <ul class="alignments list_none">
                                                <li>
                                                    ...
                                                    <span
                                                            class="selected_color_value"
                                                    >{{variantsArray[variantIndex].lang[langIndex].templateInfo.design.background.color}}</span>
                                                    <em>Opacity</em>
                                                    <input
                                                            placeholder="100"
                                                            type="text"
                                    ...
                                    <div class="txt">
                                        <ul class="alignments list_none text-right">
                                            <li>
                                                ...
                                                <span
                                                        class="selected_color_value"
                                                >{{variantsArray[variantIndex].lang[langIndex].templateInfo.design.frame.color}}</span>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="compose_widget">
                            <div class="column_text">
                                ...
                                <div class="center_text">
                                    <p>
                                        You have not yet defined key value pairs for this message.
                                        <br/>To add a new pair,
                                        click “Add New Pair”.
                                    </p>
                                </div>
                                <div class="table_header_holder">
                    ...
                    <div id="view" v-bind:class="composeTab == 4 ? 'tab_content active': 'tab_content'">
                        <div class="compose_widget">
                            <div class="column_text">
                                <p class="view_notice" v-show="rules[ruleIndex].pushInAppControl.vShow">
                                    Testing In-App
                                    Message requires push notifications to be enabled
                                    on the test devices. Ensure push is enabled before sending.
                                </p>
                                <header class="msg_inner_header">
                                    <h4>Test Recipients</h4>
                                    <p>
                                        Select at least one Content Test Group or individual user to receive this test
                                        message. Message will be customized with recipients attributes by default.
                                    </p>
                                    <div class="select_user">
                                        ...
                                        <div class="submit_holder">
                                            <button
                                                    class="user_submit"
                                                    style="background: #2a8689"
                                                    type="button"
                                                    v-bind:disabled="sendTest.disable"
        ...
        <button v-if="status === 'draft'"
                style="background-color:#2a8689;color:white;float:right"
                type="button"
                class="btn btn-default"
                v-on:click="submitStep()"
                v-bind:disabled="saveDisable"
        ><span v-if="!stepEditMode">Save</span><span v-if="stepEditMode">Update</span>
            <i
                    class="fa fa-refresh fa-spin"
                    v-bind:style="saveDisable ? 'display: inline-block': 'display: none'"
            ></i>
        </button>
    </div>
</template>
...
<script>
    ...
    import ckEditor from "../../../../otherComponents/boardCkEditor/ckEditor";
    ...
    export default {
        ...
        methods: {
            onSearch(search, loading) {
                loading(true);
                let campaignType =
                    this.campaignType.name.toLowerCase() == "email" ? "email" : "notEmail";
                let deviceType = this.variantsArray[
                    this.variantIndex
                    ].platform.name.toLowerCase();
                const payLoad = {
                    resource:
                        "company/presets/users/" +
                        search +
                        "/" +
                        campaignType +
                        "/" +
            ...
            addLang(obj) {
                for (
                    var i = 0;
                    i < this.variantsArray[this.variantIndex].totalLang.length;
                    i++
                ) {
                    if (
                        JSON.stringify(this.variantsArray[this.variantIndex].totalLang[i]) ==
                        JSON.stringify(obj)
                    ) {
                        break;
                    }
                ...
                if (i >= this.variantsArray[this.variantIndex].totalLang.length) {
                    this.removeErrors();
                    this.variantsArray[this.variantIndex].totalLang.push(
                        JSON.parse(JSON.stringify(obj))
                    );
                    var langObj = JSON.parse(JSON.stringify(this.blankLanguage));
                    langObj.language = obj.value;
                    this.variantsArray[this.variantIndex].lang.push(
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        for (
                            ...
                            if (
                                JSON.stringify(
                                    this.variantsArray[this.variantIndex].totalLang[i]
                                ) == JSON.stringify(obj)
                            ) {
                                ...
                                if (
                                    this.langIndex > i ||
                                    (this.langIndex == i &&
                                        i == this.variantsArray[this.variantIndex].lang.length - 1)
                                ) {
                                    this.langIndex--;
                                    //this.ckEditorObj.editorConfig.language = this.variantsArray[this.variantIndex].lang[this.langIndex].language;
                                }
            ...
            initialActivity() {
                ...
                this.bus.$on("switchLanguage", (data) => {
                    // let count++;
                    // debugger
                    if (data.type.toLowerCase() === "email" && data.count === 1) { // do nothing
                    } else {
                        this.switchLang('en');
                    }
                    if (data.type.toLowerCase() !== "email") {
                        this.shiftComposeTabs(1);
                    }
                    this.clearValues();
                    this.validationShow = false;
                });

                this.bus.$on("successCallAfterSavingStep", (data) => {
                    this.saveDisable = false;
                })
            },
            validateImageForInApp(obj) {
                if (
                    this.variantsArray[this.variantIndex].messageType.name.toLowerCase() ==
                    "banner"
                ) {
                    if (obj.width < 640 || obj.height < 1136) {
                        this.$swal({
                            ...
                            type: "info",
                            title:
                                "Minimum optimum size for banner image should be Width: 640px Height: 1136px",
                    ...
                    if (obj.width < 600 || obj.height < 800) {
                        this.$swal({
                            ...
                            type: "info",
                            title:
                                "Minimum optimum size for full screen image should be Width: 600px Height: 800px",
                            showConfirmButton: true
                            //toast: true
                        });
                        return false;
                    ...
                    if (obj.width < 100 || obj.height < 100) {
                        this.$swal({
                            ...
                            type: "info",
                            title:
                                "Minimum optimum size for dialog image should be Width: 100px Height: 100px",
                            showConfirmButton: true
                            //toast: true
                        });
                        return false;
                    ...
                    this.$swal({
                        ...
                        if (result.value) {
                            ...
                            if (
                                ...
                                (this.variantIndex == index &&
                                    index == this.variantsArray.length - 1)
                            ) {
                                this.variantIndex--;
                            }
                            ...
                            if (this.campaignType.name.toLowerCase() == "inapp") {
                                this.currentTemplate = this.variantsArray[
                                    this.variantIndex
            ...
            changeMessageType() {
                ...
                this.variantsArray[this.variantIndex].lang = [];
                this.variantsArray[this.variantIndex].lang.push(
                    JSON.parse(JSON.stringify(this.blankLanguage))
                );
                this.assignTemplate(this.campaignTemplates);
            },
                ...
                for (var i = 0; i < arr.length; i++) {
                    if (arr[i].type.toLowerCase() == this.campaignType.name.toLowerCase()) {
                        ...
                        for (var j = 0; j < children.length; j++) {
                            if (this.campaignType.name.toLowerCase() == "inapp") {
                                if (
                                    children[j].childType.toLowerCase() ==
                                    this.variantsArray[
                                        this.variantIndex
                                        ].messageType.name.toLowerCase()
                                ) {
                                    ...
                                    if (
                                        this.variantsArray[this.variantIndex].lang[this.langIndex]
                                            .templateInfo.template == "" ||
                                        changeAnyWay
                                    ) {
                                        this.variantsArray[this.variantIndex].lang[
                                            this.langIndex
                                            ].templateInfo.template = children[j].content[0].content;
                                    }
                                    break;
                                }
            ...
            changeTemplate(obj) {
                if (!this.rules[this.ruleIndex].title.vDisabled) {
                    ...
                    if (this.variantsArray[this.variantIndex].totalLang.length > 0)
                        $("#headingT").attr(
                            "dir",
                            this.variantsArray[this.variantIndex].totalLang[this.langIndex].dir
                        );
                }
                ...
                if (!this.rules[this.ruleIndex].action1Value.vDisabled) {
                    if (
                        obj.action1.type.name != undefined &&
                        obj.action1.type.name.toLowerCase() == "close"
                    ) {
                ...
                if (!this.rules[this.ruleIndex].action2Value.vDisabled) {
                    if (
                        obj.action2.type.name != undefined &&
                        obj.action2.type.name.toLowerCase() == "close"
                    ) {
                ...
                if (!this.rules[this.ruleIndex].brushTab.vDisabled) {
                    ...
                    if (!this.rules[this.ruleIndex].backgroundSection.vDisabled) {
                        let selector = "";
                        if (
                            this.variantsArray[this.variantIndex].messageType.name !=
                            undefined &&
                            this.variantsArray[
                                this.variantIndex
                                ].messageType.name.toLowerCase() == "dialog"
                        ) {
                    ...
                    if (!this.rules[this.ruleIndex].position.vDisabled) {
                        $("#positionDiv").css({
                            "vertical-align":
                                this.variantsArray[this.variantIndex].position.name != undefined
                                    ? this.variantsArray[
                                        this.variantIndex
                ...
                if (this.runDirective) {
                    this.variantsArray[this.variantIndex].lang[
                        this.langIndex
                        ].templateInfo.template = $("#bind_template").html();
                }
            ...
            async submitStep() {
                ...
                if (this.validateAll()) {
                    ...
                    if (this.campaignType.code.toLowerCase() == "email") {
                        await this.bus.$emit("saveEmailContent");
                    }
                    if (this.campaignType.code.toLowerCase() !== "email") {
                        this.shiftComposeTabs(1);
                    }
                    this.switchLang('en');
                    this.$emit("submitVariantStepsDetails", this.variantsArray);
                    // this.clearValues();
                } else {
                ...
                if (this.campaignType.code.toLowerCase() == "email") {
                    ...
                    if (this.currentCode == "msg_field") {
                        this.variantsArray[this.variantIndex].lang[
                            ...
                            textBefore + this.htmlDecode(attributeSpan) + textAfter;
                    } else {
                        this.variantsArray[this.variantIndex].lang[
                            this.langIndex
                            ].templateInfo.title =
            ...
            async sendNotification() {
                ...
                if (
                    ...
                    this.validateCurrentSuccess(this.variantIndex, this.langIndex)
                ) {
                    let payLoad = {
                        ...
                        data: {
                            items: [],
                            title: this.variantsArray[this.variantIndex].lang[this.langIndex]
                                .templateInfo.title,
                            message:
                                this.campaignType.name.toLowerCase() != "email"
                                    ? this.variantsArray[this.variantIndex].lang[this.langIndex]
                                        .templateInfo.message
                                    : this.variantsArray[this.variantIndex].lang[this.langIndex]
                                        .templateInfo.template,
                            ...
                            html_content: this.variantsArray[this.variantIndex].lang[
                                this.langIndex
                                ].templateInfo.template,
                            platform: this.variantsArray[
                                this.variantIndex
                                ].platform.name.toLowerCase(),
                            type: this.campaignType.name.toLowerCase(),
                            message_type: this.variantsArray[
                                this.variantIndex
                                ].messageType.name.toLowerCase(),
                            message_position: this.variantsArray[
                                this.variantIndex
                                ].position.name.toLowerCase(),
                            email: {
                            ...
                            action: {
                                type:
                                    this.variantsArray[this.variantIndex].lang[
                                        this.langIndex
                                        ].templateInfo.action1.type.name.toLowerCase() == "deep link"
                                        ? this.variantsArray[this.variantIndex].lang[this.langIndex]
                                            .templateInfo.action1.type.name
                                        : this.variantsArray[this.variantIndex].lang[
                                            this.langIndex
                                            ].templateInfo.action1.type.name.toLowerCase(),
                                value: this.variantsArray[this.variantIndex].lang[this.langIndex]
                                    .templateInfo.action1.value
                            },
                            auto_close:
                                this.campaignType.name.toLowerCase() != "inapp" ||
                                this.variantsArray[
                                    this.variantIndex
                                    ].messageType.name.toLowerCase() == "banner" ||
                                this.variantsArray[this.variantIndex].lang[this.langIndex]
                                    .templateInfo.action2.label == "" ||
                                this.variantsArray[this.variantIndex].lang[this.langIndex]
                                    .templateInfo.action2.label == null
                                    ? true
                                    : false,
                            image_url: this.variantsArray[this.variantIndex].lang[
                                this.langIndex
                                ].templateInfo.imgUrl,
                            is_board: true
                        }
                    ...
                    payLoad.data.message = btoa(
                        unescape(encodeURIComponent(payLoad.data.message))
                    );
                    payLoad.data.html_content = btoa(
                        unescape(encodeURIComponent(payLoad.data.html_content))
                    );
                ...
                if (this.campaignType.code.toLowerCase() != "email") {
                    for (let i = 0; i < this.variantsArray.length; i++) {
                        for (let j = 0; j < this.variantsArray[i].lang.length; j++) {
                            if (
                                this.campaignType.code.toLowerCase() == "push" ||
                                (this.campaignType.code.toLowerCase() == "inapp" &&
                                    this.variantsArray[i].messageType.name.toLowerCase() !=
                                    "banner")
                            ) {
                            ...
                            if (
                                ...
                                if (
                                    this.variantsArray[i].lang[j].templateInfo.action1.label == ""
                                ) {
                                    success = false;
                                ...
                                if (
                                    this.variantsArray[i].lang[j].templateInfo.action2.label !=
                                    "" &&
                                    this.variantsArray[i].lang[
                                        j
                                        ].templateInfo.action2.type.name.toLowerCase() == "url"
                                ) {
                                    let expression = /(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/gi;
                                    if (
                                        !expression.test(
                                            this.variantsArray[i].lang[j].templateInfo.action2.value
                                        )
                                    ) {
                                    ...
                                    this.variantsArray[i].lang[
                                        j
                                        ].templateInfo.action2.type.name.toLowerCase() != "close"
                                ) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            !(
                                                this.campaignType.code.toLowerCase() == "push" &&
                                                (this.variantsArray[i].lang[j].templateInfo.action2
                                                        .value == "" ||
                                                    this.variantsArray[i].lang[j].templateInfo.action2
                                                        .value == null)
                                            )
                                            ...
                                            this.errors.action2.value.message =
                                                ...
                                                this.variantsArray[i].lang[
                                                    j
                                                    ].templateInfo.action2.type.name.toLowerCase();
                                            success = false;
                                        } else {
                                            this.errors.action2.value.message = "";
                                        }
                            ...
                            if (
                                this.variantsArray[i].lang[
                                    j
                                    ].templateInfo.action1.type.name.toLowerCase() == "url"
                            ) {
                                let expression = /(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/gi;
                                if (
                                    !expression.test(
                                        this.variantsArray[i].lang[j].templateInfo.action1.value
                                    )
                                ) {
                                ...
                                this.variantsArray[i].lang[
                                    j
                                    ].templateInfo.action1.type.name.toLowerCase() != "close"
                            ) {
                                let expression1 = /[A-Za-z0-9]+:\/\/([A-Za-z0-9]+|\/)+/gi;
                                let expression2 = /(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/gi;
                                if (
                                    ...
                                    if (
                                        !(
                                            ...
                                            (this.variantsArray[i].lang[j].templateInfo.action1.value ==
                                                "" ||
                                                this.variantsArray[i].lang[j].templateInfo.action1
                                                    .value == null)
                                        )
                                    ) {
                                        this.errors.action1.value.message =
                            ...
                            if (
                                this.campaignType.code.toLowerCase() ==
                                "inapp" /*this.campaignType.code.toLowerCase() != 'email'*/
                            ) {
                ...
                if (success == false) {
                    ...
                    if (this.campaignType.name.toLowerCase() == "inapp") {
                        ...
                        for (let i = 0; i < this.rules.length; i++) {
                            if (
                                this.rules[i].name.toLowerCase() ==
                                this.currentTemplate.toLowerCase()
                            ) {
                                this.ruleIndex = i;
                                break;
                            }
            ...
            validateCurrent(i, j) {
                if (this.campaignType.code.toLowerCase() != "email") {
                    if (
                        this.campaignType.code.toLowerCase() == "push" ||
                        (this.campaignType.code.toLowerCase() == "inapp" &&
                            this.variantsArray[i].messageType.name.toLowerCase() != "banner")
                    ) {
                        if (this.variantsArray[i].lang[j].templateInfo.title == "") {
                            this.errors.title.message = "Title is required";
                        } else {
                    ...
                    if (
                        this.campaignType.code.toLowerCase() == "inapp" &&
                        (this.variantsArray[i].messageType.name.toLowerCase() == "dialog" ||
                            this.variantsArray[i].messageType.name.toLowerCase() ==
                            "full screen")
                    ) {
            ...
            validateSendTest() {
                ...
                if (this.campaignType.name.toLowerCase() == "email") {
                    let expression = /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}/gim;
        ...
        watch: {
            inAppPushData: {
                handler(currVal, oldVal) {
                    this.variantsArray[this.variantIndex].platform =
                        currVal.platformList[0];
                    this.variantsArray[this.variantIndex].messageType =
                        currVal.messageTypeList[0];
                    this.variantsArray[this.variantIndex].orientation =
                        currVal.layoutTypeList[0];
                    this.variantsArray[this.variantIndex].position =
                        currVal.devicePositionList[0];
                    this.variantsArray[this.variantIndex].lang[
                        this.langIndex
                        ].templateInfo.action1.type = currVal.actionList[0];
                    this.variantsArray[this.variantIndex].lang[
                        this.langIndex
                        ].templateInfo.action2.type = currVal.actionList[0];
                    ...
                    this.blankVariant.lang[this.langIndex].templateInfo.action1.type =
                        currVal.actionList[0];
                    this.blankVariant.lang[this.langIndex].templateInfo.action2.type =
                        currVal.actionList[0];
            ...
            languages: {
                handler(currVal, oldVal) {
                    ...
                    this.variantsArray[this.variantIndex].lang[this.langIndex].language =
                        currVal[1].value;
                    this.variantsArray[this.variantIndex].totalLang.push(
                        JSON.parse(JSON.stringify(currVal[1]))
                    );
                    this.blankVariant.lang[this.langIndex].language = currVal[1].value;
                    this.blankVariant.totalLang.push(
                        JSON.parse(JSON.stringify(currVal[1]))
                    );
            ...
            campaignType: {
                handler(currVal, oldVal) {
                    if (currVal.code.toLowerCase() == "push") {
                        this.variantsArray[this.variantIndex].lang[
                            this.langIndex
                            ].templateInfo.action1.type = JSON.parse(
                            JSON.stringify(this.deepLinkObj)
                        );
                        this.blankVariant.lang[
                            this.langIndex
                            ].templateInfo.action1.type = JSON.parse(
                            JSON.stringify(this.deepLinkObj)
                        );
                        this.blankLanguage.templateInfo.action1.type = JSON.parse(
                            JSON.stringify(this.deepLinkObj)
                        );
                    }
                    if (!this.blockForEmail) {
                        ...
                        this.variantsArray.push(
                            JSON.parse(JSON.stringify(this.blankVariant))
                        );
                    }
                    this.assignTemplate(this.campaignTemplates, true);
                },
            ...
            variantComposeDetails: {
                handler(currVal, oldVal) {
                    this.bus.$emit("makeContentToFalse")
                    if (this.campaignType.code.toLowerCase() == "email" && !currVal[0]) {
                        this.variantsArray[this.variantIndex].lang[
                            this.langIndex
                            ].templateInfo.template = this.emailTemplate;
                    }
                    // if (this.campaignType.code.toLowerCase() == "email") {
                    //     // this.shiftComposeTabs(1);
                    // }
                    if (JSON.stringify(currVal) != "{}" && currVal[0]) {
                        if (typeof currVal[0].lang[0] != "string") {
                            ...
                            this.variantsArray[this.variantIndex].lang[
                                this.langIndex
                                ].templateInfo.template = currVal[0].lang[0];
                        }
                        if (this.campaignType.code.toLowerCase() == "inapp") {
                            this.currentTemplate = this.variantsArray[
                                this.variantIndex
